...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDeleteAll(){
            var formDeviceTypes = document.getElementById("from-model_type");
            formDeviceTypes.action = "${basePath}/paramsetting/modelinfosetting/model_type_deleteSelected.action";
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            <div class="breadcrumbs" id="breadcrumbs">  <!-- 右边内容界面的导航栏-->
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">组件信息</li>
                    <li class="active">组件类型</li>
                </ul>
            </div>  <!-- .结束导航栏 -->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <h5 class="green smaller lighter">组件类型
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        ...
                        <a href="${basePath}/paramsetting/modelinfosetting/modelinfosetting/model_type_addUI.action">
                    ...
                    <form id="from-model_type"  method="post">
                    ...
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                        ...
                        <s:iterator value="pageResult.items" status="st">
                            <tr>
                                ...
                                <td>
                                    <s:property value="modelTypeNumber"/>
                                </td>

                                <td><s:property value="modelTypeName"/></td>

                                <td class="hidden-480"><s:property value="caculateType"/></td>

                                <td>
                                    <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">

                                        <button class="btn btn-xs btn-info">
                                            <a href="${basePath}/paramsetting/modelinfosetting/model_type_editUI.action?modelType.id=<s:property value='id'/>">
                                                <i class="icon-edit bigger-120"></i>
                                            </a>
                                        </button>

                                        <button class="btn btn-xs btn-danger">
                                            <a href="${basePath}/paramsetting/modelinfosetting/model_type_delete.action?modelType.id=<s:property value='id'/>">
                    ...
                    <form id="form_pageNavigator" action="${basePath}/paramsetting/modelinfosetting/model_type_listUI.action">
