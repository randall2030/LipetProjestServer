    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/modifyreasonsetting/danger_2_check_add.action">
                        <div class="form-group center">
                            <label  > 险于检测原因编号 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="text" id="dangerToCheckReasonNumber" name="dangerToCheckReason.dangerToCheckReasonNumber" placeholder="险于检测原因编号" />
                        </div>
                        <div class="form-group center">
                            <label  > 险于检测原因名称 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="text" id="dangerToCheckReasonName" name="dangerToCheckReason.dangerToCheckReasonName" placeholder="险于检测原因名称" />
                        </div>
