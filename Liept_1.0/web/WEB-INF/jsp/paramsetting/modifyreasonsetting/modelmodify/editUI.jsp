    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/modifyreasonsetting/model_modify_edit.action">
                        <div class="form-group center">
                            <label  > 组件更改原因编号 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="modelModifyReason.modifyReasonNumber"/>
                        </div>
                        <div class="form-group center">
                            <label  > 组件更改原因名称 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="modelModifyReason.modifyReasonName"/>
                        </div>
                        ...
                        <s:hidden name="modelModifyReason.id"/>
                        <s:hidden name="modelModifyReason.createPerson"/>
                        <s:hidden name="modelModifyReason.createTime"/>
                    </form>
