    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/modifyreasonsetting/delay_2_repair_add.action">
                        <div class="form-group center">
                            <label> 延迟维修原因编号 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="text" id="delayRepairReasonNumber" name="delayRepairReason.delayRepairReasonNumber" placeholder="延迟维修原因编号" />
                        </div>
                        <div class="form-group center">
                        ...
                        <div class="form-group center">
                            ...
                            <input type="text" id="delayRepairReasonName" name="delayRepairReason.delayRepairReasonName" placeholder="延迟维修原因名称" />
                        </div>
