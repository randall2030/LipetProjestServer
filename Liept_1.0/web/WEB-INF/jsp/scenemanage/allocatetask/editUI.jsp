    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form role="form" method="post" action="${basePath}/scenemanage/allocate_task_edit.action">
                        ...
                        <div class="form-group center">
                            <label class="control-label" style="padding-right: 20px">装置</label>
                            <select id="deviceName" name="task.device">
                                <option>全部</option>
                            </select>
                        </div>

                        <div class="form-group center">
                            <label class="control-label" style="padding-right: 20px">区域</label>
                            <select id="areaName" style="width: 200px;" name="task.area">
                                <option>全部</option>
                            </select>
                        </div>
                        ...
                        <s:hidden name="task.createTime"/>
                        <s:hidden name="task.createPerson"/>
                    </form>
                </div>
            </div>
        </div>
