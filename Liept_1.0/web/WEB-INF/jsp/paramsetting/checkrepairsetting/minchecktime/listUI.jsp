...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDeleteAll(){
            ...
            formDeviceTypes.action = "${basePath}/paramsetting/checkrepairsetting/min_check_time_deleteSelected.action";
    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <h5 class="green smaller lighter">最小检测时间
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        ...
                        <a href="${basePath}/paramsetting/checkrepairsetting/min_check_time_addUI.action"  style="text-decoration: none">
                    ...
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                        ...
                        <s:iterator value="pageResult.items" status="st">
                            <tr>
                                ...
                                <td class="hidden-480">
                                    <s:property value="execute==true?'是':'否'"/>
                                </td>
                                ...
                                <td>
                                    <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                        <%--<a href="${basePath}/paramsetting/checkrepairsetting/min_check_time_editUI.action?minCheckTime.id=<s:property value='id'/>">--%>
                                            <%--<i class="icon-edit bigger-120"></i>--%>
                                        <%--</a>--%>

                                        <a href="${basePath}/paramsetting/checkrepairsetting/min_check_time_delete.action?minCheckTime.id=<s:property value='id'/>">
                    ...
                    <form id="form_pageNavigator" action="${basePath}/paramsetting/checkrepairsetting/min_check_time_listUI.action">
