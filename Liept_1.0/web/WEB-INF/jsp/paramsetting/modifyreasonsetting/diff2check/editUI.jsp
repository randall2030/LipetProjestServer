    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/modifyreasonsetting/diff_2_check_edit.action">
                        <div class="form-group center">
                            <label  > 难于检测原因编号 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="diffToCheckReason.diffToCheckReasonNumber"/>
                        </div>
                        <div class="form-group center">
                            <label  > 难于检测原因名称 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="diffToCheckReason.diffToCheckReasonName"/>
                        </div>
                        ...
                        <s:hidden name="diffToCheckReason.id"/>
                        <s:hidden name="diffToCheckReason.createPerson"/>
                        <s:hidden name="diffToCheckReason.createTime"/>
                    </form>
