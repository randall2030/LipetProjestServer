...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDeleteAll(){
            var formDeviceTypes = document.getElementById("from-mediun_status");
            formDeviceTypes.action = "${basePath}/paramsetting/modelinfosetting/mediun_status_deleteSelected.action";
    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                        ...
                        <div class="panel-collapse collapse in" id="collapseOne">
                            <div class="panel-body">
                                    <form class="form-vertical"  id="from-search" role="form" method="post" enctype="multipart/form-data"
                                          action="${basePath}/paramsetting/modelinfosetting/mediun_status_listUI.action?pageNo=1">
                                        <div class="form-group">  <!--  表格的一行-->
                                            <label > 介质状态编号:</label>
                                            <s:textfield name="mediumStatus.mediumNumber" id="mediumNumber"/>
                                            &nbsp &nbsp &nbsp &nbsp
                                            <label > 介质状态名称:</label>
                                            <s:textfield name="mediumStatus.mediumName" cssClass="s_text" id="mediumName"/>
                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                            &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
                ...
                <div class="well">
                    <h5 class="green smaller lighter">介质状态

                        <a href="${basePath}/paramsetting/modelinfosetting/mediun_status_addUI.action">
                    ...
                    <form id="from-mediun_status"  method="post">
                    ...
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                        ...
                        <s:iterator value="pageResult.items" status="st">
                            <tr>
                                ...
                                <td>
                                    <s:property value="mediumNumber"/>
                                </td>

                                <td><s:property value="mediumName"/></td>

                                <td class="hidden-480"><s:property value="importReport"/></td>
                                ...
                                <td>
                                    <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                        ...
                                        <button class="btn btn-xs btn-info">
                                            <a href="${basePath}/paramsetting/modelinfosetting/mediun_status_editUI.action?mediumStatus.id=<s:property value='id'/>">
                                                <i class="icon-edit bigger-120"></i>
                                            </a>
                                        </button>

                                        <button class="btn btn-xs btn-danger">
                                            <a href="${basePath}/paramsetting/modelinfosetting/mediun_status_delete.action?mediumStatus.id=<s:property value='id'/>">
                    ...
                    <form id="form_pageNavigator" action="${basePath}/paramsetting/modelinfosetting/mediun_status_listUI.action">
