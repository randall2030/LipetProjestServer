    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/checkrepairsetting/reveal_src_edit.action">
                        <div class="form-group center">
                            <label  > 泄漏源编号 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="revealSource.revealSrcNumber"/>
                        </div>
                        <div class="form-group center">
                            <label  >组件类型&nbsp;&nbsp; </label> &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                            <select id="modelType" name="revealSource.modelType" style="width: 170px">
                                <option></option>
                            </select>
                        </div>
                        ...
                        <div class="form-group center">
                            <label  > 泄漏源名称 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="revealSource.revealSrcName"/>
                        </div>
                        ...
                        <s:hidden name="revealSource.id"/>
                        <s:hidden name="revealSource.createPerson"/>
                        <s:hidden name="revealSource.createTime"/>
                    </form>
