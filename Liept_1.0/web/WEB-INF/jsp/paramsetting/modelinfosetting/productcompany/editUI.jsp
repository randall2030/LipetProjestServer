    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/modelinfosetting/product_company_edit.action">
                        <div class="form-group center">
                            <label  > 生产厂家编号 </label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="productCompany.productCompanyNumber"/>
                        </div>

                        <div class="form-group center">
                            <label  > 生产厂家全称 </label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="productCompany.productCompanyFullName"/>
                        </div>

                        <div class="form-group center">
                            <label  > 生产厂家简称 </label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="productCompany.productCompanyShortName"/>
                        </div>
                        ...
                        <s:hidden name="productCompany.id"/>
                        <s:hidden name="productCompany.createPerson"/>
                        <s:hidden name="productCompany.createTime"/>
                    </form>
