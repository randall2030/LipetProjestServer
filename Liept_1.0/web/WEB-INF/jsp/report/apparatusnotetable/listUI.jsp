								...
								<div class="panel-collapse collapse in" id="collapseOne">
									<div class="panel-body">
										...
										<form class="form-vertical"  id="from-search" role="form" method="post"
											  action="${basePath}/report/apparatus_note_table_listUI.action?pageNo=1">
											<div class="row">
												<div class="col-md-6">
													<div class="form-horizontal">
														...
														<div class="form-group">
															<label class="col-md-4 control-label">仪器：</label>
															<div class="col-md-6">
																<select>
																	<option>全部</option>
																	<option>TVA2020-02</option>
																	<option>TVA2020-03</option>
																	<option>TVA2020-01</option>
																	<option>TVA2020-0242</option>
																	<option>EyeCGAS-0717</option>
																</select>
															</div>
														</div>
													</div>
												...
												<div class="col-md-6">
													...
													<div class="form-group" style="float: right;margin-right: 280px">
