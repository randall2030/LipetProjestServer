    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/modelinfosetting/device_manage_edit.action">
                        <div class="form-group center">
                            <label  > 装置类型编号： </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="deviceInfo.deviceNumber"/>
                        </div>

                        <div class="form-group center">
                            <label  > 装置： </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="deviceInfo.deviceName"/>
                        </div>
                        <div class="form-group center">
                            <label  > 装置类别： </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div class="form-group center">
                            <label  > 装置： </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="deviceInfo.sequenceNumber"/>
                        </div>
                        <div class="form-group center">
                            <label>部门名称：</label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <select id="deptName" name="deviceInfo.deptName" style="width:170px">
                                <option></option>
                            </select>
                        </div>
                        ...
                        <s:hidden name="deviceInfo.id"/>
                        <s:hidden name="deviceInfo.createPerson"/>
                        <s:hidden name="deviceInfo.createTime"/>
                    </form>
