...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDeleteAll(){
            var formDeviceTypes = document.getElementById("from-density_manage");
            formDeviceTypes.action = "${basePath}/paramsetting/checkrepairsetting/density_manage_deleteSelected.action";
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                <div class="well">
                    ...
                    <form class="form-vertical"  id="from-search" role="form" method="post" enctype="multipart/form-data"
                          action="${basePath}/paramsetting/checkrepairsetting/density_manage_listUI.action?pageNo=1">

                        <div class="form-group">  <!--  表格的一行-->
                            <label > 编号:</label>
                            <s:textfield name="standGasTheoryCon.number" id="number"/>
                            &nbsp &nbsp &nbsp &nbsp
                ...
                <div class="well">
                    <h5 class="green smaller lighter">标准气理论浓度管理
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        ...
                        <a href="${basePath}/paramsetting/checkrepairsetting/density_manage_addUI.action">
                    ...
                    <form id="from-density_manage"  method="post">
                    ...
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                        ...
                        <s:iterator value="pageResult.items" status="st">
                            <tr>
                                ...
                                <td class="hidden-480">
                                    <s:property value="needDailyCheck==true?'是':'否'"/>
                                </td>

                                <td>
                                    <s:property value="needErraticCheck==true?'是':'否'"/>
                                </td>
                                ...
                                <td>
                                    <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                        ...
                                        <button class="btn btn-xs btn-info">
                                            <a href="${basePath}/paramsetting/checkrepairsetting/density_manage_editUI.action?standGasTheoryCon.id=<s:property value='id'/>">
                                                <i class="icon-edit bigger-120"></i>
                                            </a>
                                        </button>

                                        <button class="btn btn-xs btn-danger">
                                            <a href="${basePath}/paramsetting/checkrepairsetting/density_manage_delete.action?standGasTheoryCon.id=<s:property value='id'/>">
                    ...
                    <form id="form_pageNavigator" action="${basePath}/paramsetting/checkrepairsetting/density_manage_listUI.action">
