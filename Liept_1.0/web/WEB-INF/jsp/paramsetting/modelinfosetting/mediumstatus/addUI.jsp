    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/modelinfosetting/mediun_status_add.action">
                        <div class="form-group center">
                            <label  > 介质编号 </label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="text" id="mediumNumber" name="mediumStatus.mediumNumber" placeholder="生产厂家编号" />
                        </div>

                        <div class="form-group center">
                            <label  > 介质名称 </label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="text" id="mediumName" name="mediumStatus.mediumName" placeholder="生产厂家全称" />
                        </div>
                        <div class="form-group center">
                            <label  > 导出报告 </label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="text" id="importReport" name="mediumStatus.importReport" placeholder="导出报告" />
                        </div>
