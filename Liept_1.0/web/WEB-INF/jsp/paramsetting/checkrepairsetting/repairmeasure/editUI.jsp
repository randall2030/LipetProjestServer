    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/checkrepairsetting/repair_measure_edit.action">
                        <div class="form-group center">
                            <label  > 维修措施编号 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="repairMeasure.repairMeasureNumber"/>
                        </div>
                        <div class="form-group center">
                            <label  >组件类型&nbsp;&nbsp; </label> &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                        ...
                        <div class="form-group center">
                            <label  > 维修措施名称 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="repairMeasure.repairMeasureName"/>
                        </div>
                        ...
                        <s:hidden name="repairMeasure.id"/>
                        <s:hidden name="repairMeasure.createPerson"/>
                        <s:hidden name="repairMeasure.createTime"/>
                    </form>
