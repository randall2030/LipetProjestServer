...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDeleteAll(){
            var formDeviceTypes = document.getElementById("from-model_modify");
            formDeviceTypes.action = "${basePath}/paramsetting/modifyreasonsetting/model_modify_deleteSelected.action";
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                <div class="well">
                                ...
                                <div class="panel-collapse collapse in" id="collapseOne">
                                    <div class="panel-body">
                                        ...
                                        <form class="form-vertical"  id="from-search" role="form" method="post" enctype="multipart/form-data"
                                              action="${basePath}/paramsetting/modifyreasonsetting/model_modify_listUI.action?pageNo=1">

                                            <div class="form-group">  <!--  表格的一行-->
                                                <label > 组件更改原因编号:</label>
                                                <input type="text" name="modelModifyReason.modifyReasonNumber" id="modifyReasonNumber"/>
                                                &nbsp
                                                <label > 组件更改原因名称:</label>
                                                <input type="text" name="modelModifyReason.modifyReasonName" id="modifyReasonName"/>
                                                &nbsp; &nbsp; &nbsp;
                    ...
                    <div class="well">
                        <h5 class="green smaller lighter">组件更改原因
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            &nbsp; &nbsp; &nbsp;
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            ...
                            <a href="${basePath}/paramsetting/modifyreasonsetting/model_modify_addUI.action">
                        ...
                        <form id="from-model_modify"  method="post">
                        ...
                        <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                            ...
                            <s:iterator value="pageResult.items" status="st">
                                <tr>
                                    ...
                                    <td>
                                        <s:property value="modifyReasonNumber"/>
                                    </td>

                                    <td class="hidden-480"><s:property value="modifyReasonName"/></td>
                                    ...
                                    <td>
                                        <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                            ...
                                            <button class="btn btn-xs btn-info">
                                                <a href="${basePath}/paramsetting/modifyreasonsetting/model_modify_editUI.action?modelModifyReason.id=<s:property value='id'/>">
                                                    <i class="icon-edit bigger-120"></i>
                                                </a>
                                            </button>

                                            <button class="btn btn-xs btn-danger">
                                                <a href="${basePath}/paramsetting/modifyreasonsetting/model_modify_delete.action?modelModifyReason.id=<s:property value='id'/>">
                        ...
                        <form id="form_pageNavigator" action="${basePath}/paramsetting/modifyreasonsetting/model_modify_listUI.action">
