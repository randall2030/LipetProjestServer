...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDeleteAll(){
            var formDeviceTypes = document.getElementById("from-equipment_manage");
            formDeviceTypes.action = "${basePath}/paramsetting/modelinfosetting/equipment_manage_deleteSelected.action";
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                <div class="well">
                    ...
                    <form class="form-vertical"  id="from-search" role="form" method="post" enctype="multipart/form-data"
                          action="${basePath}/paramsetting/modelinfosetting/equipment_manage_listUI.action?pageNo=1">

                        <div class="form-group">  <!--  表格的一行-->
                            <label > 设备编号:</label>
                            <s:textfield name="equipmentInfo.equipmentNumber" id="equipmentNumber"/>
                            &nbsp &nbsp &nbsp &nbsp
                            <label > 设备名称:</label>
                            <%--<input type="text"  name="equipmentManage.equipmentName" placeholder="设备名称"/>--%>
                            <s:textfield name="equipmentInfo.equipmentName" cssClass="s_text" id="equipmentName"/>
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                ...
                <div class="well">
                    <h5 class="green smaller lighter">设备管理
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        ...
                        <a href="${basePath}/paramsetting/modelinfosetting/equipment_manage_addUI.action">
                    ...
                    <form id="from-equipment_manage"  method="post">
                    ...
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                        ...
                        <s:iterator value="pageResult.items" status="st">
                            <tr>
                                ...
                                <td class="hidden-480"><s:property value="equipmentName"/></td>

                                <td class="hidden-480"><s:property value="areaName"/></td>

                                <td class="hidden-480"><s:property value="deviceName"/></td>
                                ...
                                <td>
                                    <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                        ...
                                        <button class="btn btn-xs btn-info">
                                            <a href="${basePath}/paramsetting/modelinfosetting/equipment_manage_editUI.action?equipmentInfo.id=<s:property value='id'/>">
                                                <i class="icon-edit bigger-120"></i>
                                            </a>
                                        </button>

                                        <button class="btn btn-xs btn-danger">
                                            <a href="${basePath}/paramsetting/modelinfosetting/equipment_manage_delete.action?equipmentInfo.id=<s:property value='id'/>">
                    ...
                    <form id="form_pageNavigator" action="${basePath}/paramsetting/modelinfosetting/equipment_manage_listUI.action">
