...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDeleteAll(){
            var formDeviceTypes = document.getElementById("from-forever_2_move");
            formDeviceTypes.action = "${basePath}/paramsetting/modifyreasonsetting/forever_2_move_deleteSelected.action";
    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div id="accordion" class="accordion-style1 panel-group">
                    ...
                    <div class="panel-collapse collapse in" id="collapseOne">
                        <div class="panel-body">
                            ...
                            <form class="form-vertical"  id="from-search" role="form" method="post" enctype="multipart/form-data"
                                  action="${basePath}/paramsetting/modifyreasonsetting/forever_2_move_listUI.action?pageNo=1">

                                <div class="form-group">  <!--  表格的一行-->
                                    <label > 永久移除原因编号:</label>
                                    <s:textfield name="foreverMoveReason.foreverMoveReasonNumber" id="foreverMoveReasonNumber"/>
                                    &nbsp &nbsp &nbsp &nbsp
                                    <label > 永久移除原因名称:</label>
                                    <s:textfield name="foreverMoveReason.foreverMoveReasonName" cssClass="s_text" id="foreverMoveReasonName"/>
                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                ...
                <div class="well">
                    <h5 class="green smaller lighter">永久移除原因
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        ...
                        <a href="${basePath}/paramsetting/modifyreasonsetting/forever_2_move_addUI.action">
                    ...
                    <form id="from-forever_2_move"  method="post">
                    ...
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                        ...
                        <s:iterator value="pageResult.items" status="st">
                            <tr>
                                ...
                                <td>
                                    <s:property value="foreverMoveReasonNumber"/>
                                </td>

                                <td><s:property value="foreverMoveReasonName"/></td>
                                ...
                                <td>
                                    <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                        ...
                                        <button class="btn btn-xs btn-info">
                                            <a href="${basePath}/paramsetting/modifyreasonsetting/forever_2_move_editUI.action?foreverMoveReason.id=<s:property value='id'/>">
                                                <i class="icon-edit bigger-120"></i>
                                            </a>
                                        </button>

                                        <button class="btn btn-xs btn-danger">
                                            <a href="${basePath}/paramsetting/modifyreasonsetting/forever_2_move_delete.action?foreverMoveReason.id=<s:property value='id'/>">
                    ...
                    <form id="form_pageNavigator" action="${basePath}/paramsetting/modifyreasonsetting/forever_2_move_listUI.action">
