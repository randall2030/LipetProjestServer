    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/modifyreasonsetting/temp_2_move_edit.action">
                        <div class="form-group center">
                            <label  > 暂时移除原因编号 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="tempMoveReason.tempMoveReasonNumber"/>
                        </div>
                        <div class="form-group center">
                            <label  > 暂时移除原因名称 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="tempMoveReason.tempMoveReasonName"/>
                        </div>
                        ...
                        <s:hidden name="tempMoveReason.id"/>
                        <s:hidden name="tempMoveReason.createPerson"/>
                        <s:hidden name="tempMoveReason.createTime"/>
                    </form>
