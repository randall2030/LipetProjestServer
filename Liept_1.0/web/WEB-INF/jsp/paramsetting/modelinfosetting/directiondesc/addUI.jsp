    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/modelinfosetting/direction_desc_add.action">
                        <div class="form-group center">
                            <label  > 描述方位编号 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="text" id="directionDescNumber" name="directionDesc.directionDescNumber" placeholder="描述方位编号" />
                        </div>
                        <div class="form-group center">
                            <label  > 描述方位名称 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="text" id="directionDescName" name="directionDesc.directionDescName" placeholder="描述方位名称" />
                        </div>
