    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/checkrepairsetting/density_manage_edit.action">
                        <div class="form-group center">
                            <label  > 编号 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="standGasTheoryCon.number"/>
                        </div>
                        <div class="form-group center">
                            <label  >&nbsp;&nbsp; PPM&nbsp;&nbsp; </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            <s:textfield name="standGasTheoryCon.ppm"/>
                        </div>
                        <div class="form-group center">
                            <label  > 需要日常校准 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:radio list="#{'true':'是','false':'否'}" value="standGasTheoryCon.needDailyCheck" name="standGasTheoryCon.needDailyCheck"/>
                        </div>
                        <div class="form-group center">
                            <label  > 需要漂移校准 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:radio list="#{'true':'是','false':'否'}" value="standGasTheoryCon.needErraticCheck" name="standGasTheoryCon.needErraticCheck"/>
                        </div>
                        ...
                        <s:hidden name="standGasTheoryCon.id"/>
                    </form>
