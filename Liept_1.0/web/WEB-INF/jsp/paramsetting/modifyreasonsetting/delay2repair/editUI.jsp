    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/modifyreasonsetting/delay_2_repair_edit.action">
                        <div class="form-group center">
                            <label  > 延迟维修原因编号 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="delayRepairReason.delayRepairReasonNumber"/>
                        </div>

                        <div class="form-group center">
                            <label  >延迟维修原因名称 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="delayRepairReason.delayRepairReasonName"/>
                        </div>
                        ...
                        <s:hidden name="delayRepairReason.id"/>
                        <s:hidden name="delayRepairReason.createPerson"/>
                        <s:hidden name="delayRepairReason.createTime"/>
                    </form>
