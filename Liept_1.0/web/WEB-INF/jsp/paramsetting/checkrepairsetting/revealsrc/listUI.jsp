...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDeleteAll(){
            var formDeviceTypes = document.getElementById("from-reveal_src");
            formDeviceTypes.action = "${basePath}/paramsetting/checkrepairsetting/reveal_src_deleteSelected.action";
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                <div class="well">
                    ...
                    <form class="form-vertical"  id="from-search" role="form" method="post" enctype="multipart/form-data"
                          action="${basePath}/paramsetting/checkrepairsetting/reveal_src_listUI.action?pageNo=1">

                        <div class="form-group">  <!--  表格的一行-->
                            <label > 泄漏源编号:</label>
                            <s:textfield name="revealSource.revealSrcNumber" id="revealSrcNumber"/>
                            &nbsp &nbsp &nbsp &nbsp
                            <label > 泄漏源名称:</label>
                            <s:textfield name="revealSource.revealSrcName" cssClass="s_text" id="revealSrcName"/>
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            <label > 组件类型名称:</label>
                            <s:textfield name="revealSource.modelType" cssClass="s_text" id="modelType"/>
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                ...
                <div class="well">
                    <h5 class="green smaller lighter">泄漏源
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        ...
                        <a href="${basePath}/paramsetting/checkrepairsetting/reveal_src_addUI.action">
                    ...
                    <form id="from-reveal_src"  method="post">
                    ...
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                        ...
                        <s:iterator value="pageResult.items" status="st">
                            <tr>
                                ...
                                <td>
                                    <s:property value="revealSrcNumber"/>
                                </td>

                                <td><s:property value="revealSrcName"/></td>
                                ...
                                <td>
                                    <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                        ...
                                        <button class="btn btn-xs btn-info">
                                            <a href="${basePath}/paramsetting/checkrepairsetting/reveal_src_editUI.action?revealSource.id=<s:property value='id'/>">
                                                <i class="icon-edit bigger-120"></i>
                                            </a>
                                        </button>

                                        <button class="btn btn-xs btn-danger">
                                            <a href="${basePath}/paramsetting/checkrepairsetting/reveal_src_delete.action?revealSource.id=<s:property value='id'/>">
                    ...
                    <form id="form_pageNavigator" action="${basePath}/paramsetting/checkrepairsetting/reveal_src_listUI.action">
