    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/checkrepairsetting/reveal_src_add.action">
                        <div class="form-group center">
                            <label  > 泄漏源编号 </label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="text" id="revealSrcNumber" name="revealSource.revealSrcNumber" placeholder="泄漏源编号" />
                        </div>
                        <div class="form-group center">
                            <label  >组件类型&nbsp;&nbsp; </label> &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                        ...
                        <div class="form-group center">
                            <label  > 泄漏源名称 </label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="text" id="revealSrcName" name="revealSource.revealSrcName" placeholder="泄漏源名称" />
                        </div>
