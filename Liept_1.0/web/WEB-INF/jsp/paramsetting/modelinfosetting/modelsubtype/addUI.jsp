    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/modelinfosetting/model_sub_type_add.action">
                        <div class="form-group center">
                            <label  > 组件子类型编号 </label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="text" id="modelSubTypeNumber" name="modelSubType.modelSubTypeNumber" placeholder="组件子类型编号" />
                        </div>

                        <div class="form-group center">
                            <label  > 组件子类型名称 </label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="text" id="modeSubTypeName" name="modelSubType.modeSubTypeName" placeholder="组件子类型名称" />
                        </div>

                        <div class="form-group center">
                            <label  >类型</label> &nbsp;  &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="text" id="modelType" name="modelSubType.type" placeholder="类型" />
                        </div>
