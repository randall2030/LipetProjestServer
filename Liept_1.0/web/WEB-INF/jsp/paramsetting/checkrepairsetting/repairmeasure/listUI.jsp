...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDeleteAll(){
            var formDeviceTypes = document.getElementById("from-repair_measure");
            formDeviceTypes.action = "${basePath}/paramsetting/checkrepairsetting/repair_measure_deleteSelected.action";
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                <div class="well">
                    ...
                    <form class="form-vertical"  id="from-search" role="form" method="post" enctype="multipart/form-data"
                          action="${basePath}/paramsetting/checkrepairsetting/repair_measure_listUI.action?pageNo=1">

                        <div class="form-group">  <!--  表格的一行-->
                            <label > 维修措施编号:</label>
                            <s:textfield name="repairMeasure.repairMeasureNumber" id="repairMeasureNumber"/>
                            &nbsp &nbsp &nbsp &nbsp
                            <label > 维修措施名称:</label>
                            <s:textfield name="repairMeasure.repairMeasureName" id="repairMeasureName"/>
                            &nbsp &nbsp &nbsp &nbsp
                            <label > 组件类型名称:</label>

                            <select id="modelType" name="repairMeasure.modelType" placeholder="组件类型"/>
                ...
                <div class="well">
                    <h5 class="green smaller lighter">维修措施
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        ...
                        &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;
                        <a href="${basePath}/paramsetting/checkrepairsetting/repair_measure_addUI.action">
                    ...
                    <form id="from-repair_measure"  method="post">
                    ...
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                        ...
                        <s:iterator value="pageResult.items" status="st">
                            <tr>
                                ...
                                <td>
                                    <s:property value="repairMeasureNumber"/>
                                </td>

                                <td><s:property value="repairMeasureName"/></td>

                                <td class="hidden-480">
                                    <s:property value="modelType"/></td>
                                ...
                                <td>
                                    <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                        ...
                                        <button class="btn btn-xs btn-info">
                                            <a href="${basePath}/paramsetting/checkrepairsetting/repair_measure_editUI.action?repairMeasure.id=<s:property value='id'/>">
                                                <i class="icon-edit bigger-120"></i>
                                            </a>
                                        </button>

                                        <button class="btn btn-xs btn-danger">
                                            <a href="${basePath}/paramsetting/checkrepairsetting/repair_measure_delete.action?repairMeasure.id=<s:property value='id'/>">
                    ...
                    <form id="form_pageNavigator" action="${basePath}/paramsetting/checkrepairsetting/repair_measure_listUI.action">
