    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/checkrepairsetting/check_apparatus_add.action">
                        <div class="form-group center">
                            <label  > 序列号 </label> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="text" id="sequenceNumber" name="checkApparatus.sequenceNumber" placeholder="序列号" />
                        </div>
                        <div class="form-group center">
                            <label  >检测仪器名称&nbsp;&nbsp; </label>&nbsp;
                            <input type="text" id="apparatusName" name="checkApparatus.apparatusName" placeholder="检测仪器名称" />
                        </div>
                        <div class="form-group center">
                            &nbsp; &nbsp;&nbsp;<label  > 响应时间 </label>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="text" id="reactTime" name="checkApparatus.reactTime" placeholder="响应时间" />秒
                        </div>
                        <div class="form-group center">
                           <label  > 最后精密校验时间 </label>&nbsp; &nbsp;&nbsp;
                            <input type="date" name="checkApparatus.lastCheckTime"/>
                        </div>
