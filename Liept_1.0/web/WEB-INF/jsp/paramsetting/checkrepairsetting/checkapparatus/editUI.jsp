    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/checkrepairsetting/check_apparatus_edit.action">
                        <div class="form-group center">
                            <label  > 序列号 </label>  &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="checkApparatus.sequenceNumber"/>
                        </div>
                        <div class="form-group center">
                            <label  >&nbsp;&nbsp; 检测仪器名称&nbsp;&nbsp; </label>&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;
                            <s:textfield name="checkApparatus.apparatusName"/>
                        </div>
                        <div class="form-group center">
                            <label  > 最后精密校验时间 </label>&nbsp;&nbsp;
                            <input type="date" name="checkApparatus.lastCheckTime" value=${checkTime.get(0)} >
                        </div>
                        <div class="form-group center">
                            <label  > 响应时间 </label> &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="checkApparatus.reactTime"/>
                        </div>
                        ...
                        <s:hidden name="checkApparatus.id"/>
                        <s:hidden name="checkApparatus.createPerson"/>
                        <s:hidden name="checkApparatus.createTime"/>
                    </form>
