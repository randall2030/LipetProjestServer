                        ...
                        <div class="panel-collapse collapse in" id="collapseOne">
                            <div class="panel-body">
                                ...
                                <form class="form-vertical" id="from-export" role="form" method="post"
                                      action="${basePath}/report/leak_history_exportLeakInfo.action?pageNo=1">
                                    ...
                                    <div class="checkbox">
                                        ...
                                        <div class="col-md-3 col-md-offset-9">
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="device" type="checkbox"
                                            ...
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="area" type="checkbox"
                                                           checked="checked" class="ace"/>
                                            ...
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="labelNumber" type="checkbox"
                                                           checked="checked" class="ace"/>
                                            ...
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="extendNumber" type="checkbox"
                                                           checked="checked" class="ace"/>
                                            ...
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="locationDesc" type="checkbox"
                                                           class="ace"/>
                                            ...
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="moduleType" type="checkbox"
                                                           checked="checked" class="ace"/>
                                            ...
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="sizeMM" type="checkbox"
                                                           checked="checked" class="ace"/>
                                            ...
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="mediumStatus" type="checkbox"
                                                           checked="checked" class="ace"/>
                                            ...
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="leakThreshold" type="checkbox"
                                                           class="ace"/>
                                                    <span class="lbl">泄漏阈值</span>
                                                </label>
                                            </div>
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="checkDate" type="checkbox"
                                                           class="ace"/>
                                                    <span class="lbl">检测日期</span>
                                                </label>
                                            </div>
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="checkPerson" type="checkbox"
                                                           class="ace"/>
                                                    <span class="lbl">检测人</span>
                                                </label>
                                            </div>
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="checkEquipment" type="checkbox"
                                                           class="ace"/>
                                                    <span class="lbl">检测仪器</span>
                                                </label>
                                            </div>
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="backgroundPPMNumber" type="checkbox"
                                                           class="ace"/>
                                                    <span class="lbl">背景值PPM读数</span>
                                                </label>
                                            </div>
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="cleanPPMValue" type="checkbox"
                                                           class="ace"/>
                                                    <span class="lbl">净PPM读数</span>
                                                </label>
                                            </div>
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="leakSource" type="checkbox"
                                                           class="ace"/>
                                                    <span class="lbl">泄漏源</span>
                                                </label>
                                            </div>
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="repairResult" type="checkbox"
                                                           class="ace"/>
                                                    <span class="lbl">泄漏修复</span>
                                                </label>
                                            </div>
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="repairNumber" type="checkbox"
                                                           class="ace"/>
                                                    <span class="lbl">维修次数</span>
                                                </label>
                                            </div>
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="firstRepeateValue" type="checkbox"
                                                           class="ace"/>
                                                    <span class="lbl">首次复测值</span>
                                                </label>
                                            </div>
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="firstRepeateDate" type="checkbox"
                                                           class="ace"/>
                                                    <span class="lbl">首次复测日期</span>
                                                </label>
                                            </div>
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="endRepeateValue" type="checkbox"
                                                           class="ace"/>
                                                    <span class="lbl">最终复测值</span>
                                                </label>
                                            </div>
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="endRepeateDate" type="checkbox"
                                                           class="ace"/>
                                                    <span class="lbl">最终复测日期</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
