			...
			<div class="main-container-inner">             <!-- 还是最外层-->
				...
				<div class="main-content">             <!-- 右边内容界面-->
						...
						<div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面--> 
							...
							<form  role="form" action="${basePath}/paramsetting/device_type_add.action">
									<div class="form-group center">
										<label  > 装置类别编号 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="text" id="deviceTypeNumber" name="deviceType.deviceTypeNumber" placeholder="装置类型编号" />
									</div>
									<div class="form-group center">
										<label  >&nbsp;&nbsp;装置类别</label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="text" id="type" name="deviceType.type" placeholder="类型" />
									</div>
