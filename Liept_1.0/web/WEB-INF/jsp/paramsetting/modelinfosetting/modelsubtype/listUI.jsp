...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDeleteAll(){
            var formDeviceTypes = document.getElementById("from-model_sub");
            formDeviceTypes.action = "${basePath}/paramsetting/modelinfosetting/model_sub_type_deleteSelected.action";
    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                            ...
                            <div class="panel-collapse collapse in" id="collapseOne">
                                <div class="panel-body">
                                        ...
                                        <form class="form-vertical"  id="from-search" role="form" method="post" enctype="multipart/form-data"
                                              action="${basePath}/paramsetting/modelinfosetting/model_sub_type_listUI.action?pageNo=1">
                                            <div class="form-group">  <!--  表格的一行-->
                                                <label > 组件子类型编号:</label>
                                                <s:textfield name="modelSubType.modelSubTypeNumber" id="modelSubTypeNumber"/>
                                                &nbsp &nbsp &nbsp &nbsp
                                                <label > 组件子类型名称:</label>
                                                <s:textfield name="modelSubType.modeSubTypeName" id="modeSubTypeName"/>
                                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                <label > 组件类型名称:</label>
                                                <s:textfield name="modelSubType.modelType" id="modelType"/>
                                                &nbsp; &nbsp;
                ...
                <div class="well">
                    <h5 class="green smaller lighter">组件子类型
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            <a href="${basePath}/paramsetting/modelinfosetting/model_sub_type_addUI.action">
                    ...
                    <form id="from-model_sub"  method="post">
                    ...
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                        ...
                        <s:iterator value="pageResult.items" status="st">
                            <tr>
                                ...
                                <td>
                                    <s:property value="modelSubTypeNumber"/>
                                </td>

                                <td><s:property value="type"/></td>

                                <td class="hidden-480"><s:property value="modeSubTypeName"/></td>
                                ...
                                <td>
                                    <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                        ...
                                        <button class="btn btn-xs btn-info">
                                            <a href="${basePath}/paramsetting/modelinfosetting/model_sub_type_editUI.action?modelSubType.id=<s:property value='id'/>">
                                                <i class="icon-edit bigger-120"></i>
                                            </a>
                                        </button>

                                        <button class="btn btn-xs btn-danger">
                                            <a href="${basePath}/paramsetting/modelinfosetting/model_sub_type_delete.action?modelSubType.id=<s:property value='id'/>">
                    ...
                    <form id="form_pageNavigator" action="${basePath}/paramsetting/modelinfosetting/model_sub_type_listUI.action">
