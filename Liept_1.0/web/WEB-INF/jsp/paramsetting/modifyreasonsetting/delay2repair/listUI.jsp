...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDeleteAll(){
            var formDeviceTypes = document.getElementById("from-delay_2_repair");
            formDeviceTypes.action = "${basePath}/paramsetting/modifyreasonsetting/delay_2_repair_deleteSelected.action";
    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                            ...
                            <div class="panel-collapse collapse in" id="collapseOne">
                                <div class="panel-body">
                                    ...
                                    <form class="form-vertical"  id="from-search" role="form" method="post" enctype="multipart/form-data"
                                          action=   "${basePath}/paramsetting/modifyreasonsetting/delay_2_repair_listUI.action?pageNo=1">

                                        <div class="form-group">  <!--  表格的一行-->
                                            <label > 延迟维修原因编号:</label>
                                            <s:textfield name="delayRepairReason.delayRepairReasonNumber" id="deviceTypeNumber"/>
                                            &nbsp &nbsp &nbsp &nbsp
                                            <label > 延迟维修原因名称:</label>
                                            <s:textfield name="delayRepairReason.delayRepairReasonName" cssClass="s_text" id="deviceTypeName"/>
                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                ...
                <div class="well">
                    <h5 class="green smaller lighter">延迟维修原因
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        ...
                        <a href="${basePath}/paramsetting/modifyreasonsetting/delay_2_repair_addUI.action">
                    ...
                    <form id="from-delay_2_repair"  method="post">
                    ...
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                        ...
                        <s:iterator value="pageResult.items" status="st">
                            <tr>
                                ...
                                <td>
                                    <s:property value="delayRepairReasonNumber"/>
                                </td>

                                <td><s:property value="delayRepairReasonName"/></td>
                                ...
                                <td>
                                    <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                        ...
                                        <button class="btn btn-xs btn-info">
                                            <a href="${basePath}/paramsetting/modifyreasonsetting/delay_2_repair_editUI.action?delayRepairReason.id=<s:property value='id'/>">
                                                <i class="icon-edit bigger-120"></i>
                                            </a>
                                        </button>

                                        <button class="btn btn-xs btn-danger">
                                            <a href="${basePath}/paramsetting/modifyreasonsetting/delay_2_repair_delete.action?delayRepairReason.id=<s:property value='id'/>">
                    ...
                    <form id="form_pageNavigator" action="${basePath}/paramsetting/modifyreasonsetting/delay_2_repair_listUI.action">
