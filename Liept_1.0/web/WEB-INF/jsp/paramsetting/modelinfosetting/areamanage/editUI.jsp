    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/modelinfosetting/area_manage_edit.action">
                        <div class="form-group center">
                            <label  > 区域编号 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="areaInfo.areaNumber"/>
                        </div>
                        <div class="form-group center">
                            <label>装置名称</label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <select id="deviceName" name="areaInfo.deviceName" style="width:170px">
                                <option></option>
                            </select>
                        </div>
                        <!--查询 装置名称-->
                        ...
                        <div class="form-group center">
                            <label  > 区域名称 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="areaInfo.areaName"/>
                        </div>
                        ...
                        <s:hidden name="areaInfo.id"/>
                        <s:hidden name="areaInfo.createPerson"/>
                        <s:hidden name="areaInfo.createTime"/>
                    </form>
