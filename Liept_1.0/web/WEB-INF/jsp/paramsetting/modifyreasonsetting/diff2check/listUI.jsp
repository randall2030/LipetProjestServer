...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDeleteAll(){
            var formDeviceTypes = document.getElementById("from-diff_2_check");
            formDeviceTypes.action = "${basePath}/paramsetting/modifyreasonsetting/diff_2_check_deleteSelected.action";
    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                                ...
                                <div class="panel-collapse collapse in" id="collapseOne">
                                    <div class="panel-body">
                                        ...
                                        <form class="form-vertical"  id="from-search" role="form" method="post" enctype="multipart/form-data"
                                              action="${basePath}/paramsetting/modifyreasonsetting/diff_2_check_listUI.action?pageNo=1">

                                            <div class="form-group">  <!--  表格的一行-->
                                                <label > 难于检测原因编号:</label>
                                                <input type="text" name="diffToCheckReason.diffToCheckReasonNumber" id="diffToCheckReasonNumber" />
                                                &nbsp
                                                <label > 难于检测原因名称:</label>
                                                <input type="text" name="diffToCheckReason.diffToCheckReasonName" id="diffToCheckReasonName"/>
                                                &nbsp; &nbsp; &nbsp;
                ...
                <div class="well">
                        <h5 class="green smaller lighter">难于检测原因
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            &nbsp; &nbsp; &nbsp;
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            ...
                            <a href="${basePath}/paramsetting/modifyreasonsetting/diff_2_check_addUI.action">
                    ...
                    <form id="from-diff_2_check"  method="post">
                        ...
                        <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                            ...
                            <s:iterator value="pageResult.items" status="st">
                                <tr>
                                    ...
                                    <td>
                                        <s:property value="diffToCheckReasonNumber"/>
                                    </td>

                                    <td class="hidden-480"><s:property value="diffToCheckReasonName"/></td>
                                    ...
                                    <td>
                                        <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                            ...
                                            <button class="btn btn-xs btn-info">
                                                <a href="${basePath}/paramsetting/modifyreasonsetting/diff_2_check_editUI.action?diffToCheckReason.id=<s:property value='id'/>">
                                                    <i class="icon-edit bigger-120"></i>
                                                </a>
                                            </button>

                                            <button class="btn btn-xs btn-danger">
                                                <a href="${basePath}/paramsetting/modifyreasonsetting/diff_2_check_delete.action?diffToCheckReason.id=<s:property value='id'/>">
                        ...
                        <form id="form_pageNavigator" action="${basePath}/paramsetting/modifyreasonsetting/diff_2_check_listUI.action">
