...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDeleteAll() {
            var formDeviceTypes = document.getElementById("from-check_apparatus");
            formDeviceTypes.action = "${basePath}/paramsetting/checkrepairsetting/check_apparatus_deleteSelected.action";
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                <div class="well">
                    ...
                    <form class="form-vertical" id="from-search" role="form" method="post" enctype="multipart/form-data"
                          action="${basePath}/paramsetting/checkrepairsetting/check_apparatus_listUI.action?pageNo=1">

                        <div class="form-group">  <!--  表格的一行-->
                            <label> 序列号:</label>
                            <s:textfield name="checkApparatus.sequenceNumber" id="sequenceNumber"/>
                            &nbsp &nbsp &nbsp &nbsp
                            <label> 检测仪器名称:</label>
                            <s:textfield name="checkApparatus.apparatusName" cssClass="s_text" id="apparatusName"/>
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;
                            &nbsp;
                ...
                <div class="well">
                    <h5 class="green smaller lighter">检测仪器
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        ...
                        <a href="${basePath}/paramsetting/checkrepairsetting/check_apparatus_addUI.action">
                    ...
                    <form id="from-check_apparatus" method="post">
                        ...
                        <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                            ...
                            <s:iterator value="pageResult.items" status="st">
                                <tr>
                                    ...
                                    <td><s:property value="apparatusName"/></td>

                                    <td class="hidden-480">
                                        <s:date name="lastCheckTime" format="yyyy-MM-dd"/>
                                    </td>

                                    <td><s:property value="reactTime"/></td>
                                    <td>
                                        <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">

                                                <a href="${basePath}/paramsetting/checkrepairsetting/check_apparatus_editUI.action?checkApparatus.id=<s:property value='id'/>">
                                                    <i class="icon-edit bigger-120"></i>
                                                </a>
                                                <a href="${basePath}/paramsetting/checkrepairsetting/check_apparatus_delete.action?checkApparatus.id=<s:property value='id'/>">
                    ...
                    <form id="form_pageNavigator"
                          action="${basePath}/paramsetting/checkrepairsetting/check_apparatus_listUI.action">
