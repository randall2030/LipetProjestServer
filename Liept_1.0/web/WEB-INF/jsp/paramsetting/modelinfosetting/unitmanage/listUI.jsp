...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDeleteAll(){
            var formDeviceTypes = document.getElementById("from-unit_manage");
            formDeviceTypes.action = "${basePath}/paramsetting/modelinfosetting/unit_manage_deleteSelected.action";
    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-collapse collapse in" id="collapseOne">
                                    <form class="form-vertical"  id="from-search" role="form" method="post" enctype="multipart/form-data"
                                          action="${basePath}/paramsetting/modelinfosetting/unit_manage_listUI.action?pageNo=1">

                                        <div class="form-group">  <!--  表格的一行-->
                                            <label > 单位编号:</label>
                                            <s:textfield name="unit.unitNumber" id="unitNumber"/>
                                            &nbsp &nbsp &nbsp &nbsp
                                            <label > 单位名称:</label>
                                            <s:textfield name="unit.unitName" cssClass="s_text" id="unitName"/>
                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                            &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                ...
                <div class="well">
                    <h5 class="green smaller lighter">单位管理
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        ...
                        <a href="${basePath}/paramsetting/modelinfosetting/unit_manage_addUI.action">
                    ...
                    <form id="from-unit_manage"  method="post">
                    ...
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                        ...
                        <s:iterator value="pageResult.items" status="st">
                            <tr>
                                ...
                                <td>
                                    <s:property value="unitNumber"/>
                                </td>


                                <td class="hidden-480"><s:property value="unitName"/></td>
                                ...
                                <td>
                                    <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                        ...
                                        <button class="btn btn-xs btn-info">
                                            <a href="${basePath}/paramsetting/modelinfosetting/unit_manage_editUI.action?unit.id=<s:property value='id'/>">
                                                <i class="icon-edit bigger-120"></i>
                                            </a>
                                        </button>

                                        <button class="btn btn-xs btn-danger">
                                            <a href="${basePath}/paramsetting/modelinfosetting/unit_manage_delete.action?unit.id=<s:property value='id'/>">
                    ...
                    <form id="form_pageNavigator" action="${basePath}/paramsetting/modelinfosetting/unit_manage_listUI.action">
