    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/modelinfosetting/mediun_status_edit.action">
                        <div class="form-group center">
                            <label  > 介质编号 </label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="mediumStatus.mediumNumber"/>
                        </div>

                        <div class="form-group center">
                            <label  > 介质名称 </label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="mediumStatus.mediumName"/>
                        </div>
                        <div class="form-group center">
                            <label  > 导出报告 </label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="mediumStatus.importReport"/>
                        </div>
                        ...
                        <s:hidden name="mediumStatus.id"/>
                        <s:hidden name="mediumStatus.createPerson"/>
                        <s:hidden name="mediumStatus.createTime"/>
                    </form>
