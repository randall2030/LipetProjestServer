...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDeleteAll(){
            var formDeviceTypes = document.getElementById("from-area_manage");
            formDeviceTypes.action = "${basePath}/paramsetting/modelinfosetting/area_manage_deleteSelected.action";
    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                <div class="well">
                    <h5 class="green smaller lighter">区域信息
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        ...
                        <a href="${basePath}/paramsetting/modelinfosetting/area_manage_addUI.action">
                    ...
                    <form id="from-area_manage"  method="post">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                            <a href="${basePath}/paramsetting/modelinfosetting/area_manage_editUI.action?areaInfo.id=<s:property value='id'/>">
                                                <i class="icon-edit bigger-120"></i>
                                            </a>

                                            <a href="${basePath}/paramsetting/modelinfosetting/area_manage_delete.action?areaInfo.id=<s:property value='id'/>">
                    ...
                    <form id="form_pageNavigator" action="${basePath}/paramsetting/modelinfosetting/area_manage_listUI.action">
