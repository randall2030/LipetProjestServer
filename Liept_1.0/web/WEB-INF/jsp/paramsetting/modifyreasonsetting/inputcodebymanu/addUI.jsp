    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/modifyreasonsetting/input_code_by_manu_add.action">
                        <div class="row">
                            <div class="col-md-4 col-md-offset-4">
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="manuInputCodeReason.manuInputCodeReasonNumber" placeholder="编号">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-5 control-label" style="padding-right:0px">手动输入条形码原因</label>
                                        <div class="col-md-6">
                                            <input type="text" name="manuInputCodeReason.manuInputCodeReasonName" placeholder="手动输入条形码原因">
                                        </div>
                                    </div>
                                </div>
                            </div>
