    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                            ...
                            <div class="panel-collapse collapse in" id="collapseOne">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-vertical" id="from-query" role="form" method="post"
                                          action="${basePath}/view/module_info_listUI.action?pageNo=1">
                ...
                <div class="well">
                    <h5 class="green smaller lighter">密封点信息
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        ...
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp;
                        <%--<div style="float:right;margin-right:100px;margin-bottom:20px">--%>
                            <%--<a href="${basePath}/view/moduleinfo/module_info_addUI.action">--%>
                                <%--<button style="height:40px" class="btn btn-info" type="button">--%>
                                    <%--<i class=" icon-circle-arrow-down align-top bigger-125"></i>--%>
                                    <%--添加--%>
                                <%--</button>--%>
                            <%--</a>--%>
                        <%--</div>--%>
                    ...
                    <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                <a href="${basePath}/view/module_info_editUI.action?module.id=<s:property value='id'/>">
                                                    <i class="icon-edit bigger-120"></i>
                                                </a>
                                                <a href="${basePath}/view/module_info_delete.action?module.id=<s:property value='id'/>">
                        ...
                        <form id="form_pageNavigator" action="${basePath}/view/moduleinfo/module_info_listUI.action">
