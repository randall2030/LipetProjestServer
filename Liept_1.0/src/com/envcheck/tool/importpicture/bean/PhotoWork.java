...
public class PhotoWork implements Serializable {
    ...
    public boolean isHidePreMark() {
        return isHidePreMark;
    }

    public void setHidePreMark(boolean hidePreMark) {
        isHidePreMark = hidePreMark;
    }
    ...
    public ArrayList<LayoutBean> getPreMark() {
        return preMark;
    }

    public void setPreMark(ArrayList<LayoutBean> preMark) {
