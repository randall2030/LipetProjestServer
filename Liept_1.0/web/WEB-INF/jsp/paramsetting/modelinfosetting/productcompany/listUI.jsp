...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDeleteAll(){
            var formDeviceTypes = document.getElementById("from-product_company");
            formDeviceTypes.action = "${basePath}/paramsetting/modelinfosetting/product_company_deleteSelected.action";
    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                        ...
                        <div class="panel-collapse collapse in" id="collapseOne">
                            <div class="panel-body">
                                    ...
                                    <form class="form-vertical"  id="from-search" role="form" method="post" enctype="multipart/form-data"
                                          action="${basePath}/paramsetting/modelinfosetting/product_company_listUI.action?pageNo=1">
                                        <div class="form-group">  <!--  表格的一行-->
                                            <label > 生产厂家编号:</label>
                                            <s:textfield name="productCompany.productCompanyNumber" id="productCompanyNumber"/>
                                            &nbsp &nbsp &nbsp &nbsp
                                            <label > 生产厂家全称:</label>
                                            <s:textfield name="productCompany.productCompanyFullName" cssClass="s_text" id="productCompanyFullName"/>
                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                            &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
                ...
                <div class="well">
                    <h5 class="green smaller lighter">生产厂家

                        <a href="${basePath}/paramsetting/modelinfosetting/product_company_addUI.action">
                    ...
                    <form id="from-product_company"  method="post">
                    ...
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                        ...
                        <s:iterator value="pageResult.items" status="st">
                            <tr>
                                ...
                                <td><s:property value="productCompanyNumber"/></td>

                                <td><s:property value="productCompanyShortName"/></td>

                                <td class="hidden-480"><s:property value="productCompanyFullName"/></td>
                                ...
                                <td>
                                    <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                        ...
                                        <button class="btn btn-xs btn-info">
                                            <a href="${basePath}/paramsetting/modelinfosetting/product_company_editUI.action?productCompany.id=<s:property value='id'/>">
                                                <i class="icon-edit bigger-120"></i>
                                            </a>
                                        </button>

                                        <button class="btn btn-xs btn-danger">
                                            <a href="${basePath}/paramsetting/modelinfosetting/product_company_delete.action?productCompany.id=<s:property value='id'/>">
                    ...
                    <form id="form_pageNavigator" action="${basePath}/paramsetting/modelinfosetting/product_company_listUI.action">
