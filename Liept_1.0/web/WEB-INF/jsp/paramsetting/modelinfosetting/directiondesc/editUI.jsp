    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/modelinfosetting/direction_desc_edit.action">
                        <div class="form-group center">
                            <label  > 描述方位编号 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="directionDesc.directionDescNumber"/>
                        </div>
                        <div class="form-group center">
                            <label  > 描述方位名称 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="directionDesc.directionDescName"/>
                        </div>
                        ...
                        <s:hidden name="directionDesc.id"/>
                        <s:hidden name="directionDesc.createPerson"/>
                        <s:hidden name="directionDesc.createTime"/>
                    </form>
