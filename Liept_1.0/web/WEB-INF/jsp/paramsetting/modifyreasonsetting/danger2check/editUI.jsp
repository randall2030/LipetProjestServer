    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/modifyreasonsetting/danger_2_check_edit.action">
                        <div class="form-group center">
                            <label  > 险于检测原因编号 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="dangerToCheckReason.dangerToCheckReasonNumber"/>
                        </div>
                        <div class="form-group center">
                            <label  > 险于检测原因名称 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="dangerToCheckReason.dangerToCheckReasonName"/>
                        </div>
                        ...
                        <s:hidden name="dangerToCheckReason.id"/>
                        <s:hidden name="dangerToCheckReason.createPerson"/>
                        <s:hidden name="dangerToCheckReason.createTime"/>
                    </form>
