    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/modelinfosetting/caculate_type_add.action">
                        <div class="form-group center">
                            <label  > 计算类别编号 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="text" id="caculateTypeNumber" name="caculateType.caculateTypeNumber" placeholder="计算类别编号" />
                        </div>
                        <div class="form-group center">
                            <label  > 计算类别名称 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="text" id="caculateTypeName" name="caculateType.caculateTypeName" placeholder="计算类别名称" />
                        </div>
