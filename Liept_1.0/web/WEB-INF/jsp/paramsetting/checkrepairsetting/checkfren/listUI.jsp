...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDeleteAll() {
            var formDeviceTypes = document.getElementById("from-check_fren");
            formDeviceTypes.action = "${basePath}/paramsetting/checkrepairsetting/check_fren_deleteSelected.action";
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                <div class="well">
                    ...
                    <form class="form-vertical" id="from-search" role="form" method="post" enctype="multipart/form-data"
                          action="${basePath}/paramsetting/checkrepairsetting/check_fren_listUI.action?pageNo=1">

                        <div class="form-group">  <!--  表格的一行-->
                            <label> 检测频率编号:</label>
                            <s:textfield name="checkFrequency.checkFrequencyNumber" id="checkFrequencyNumber"/>
                            &nbsp &nbsp &nbsp &nbsp
                            <label> 检测频率名称:</label>
                            <s:textfield name="checkFrequency.checkFrequencyName" cssClass="s_text"
                ...
                <div class="well">
                    <h5 class="green smaller lighter">检测频率
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        ...
                        <a href="${basePath}/paramsetting/checkrepairsetting/check_fren_addUI.action">
                    ...
                    <form id="from-check_fren" method="post">
                            ...
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover"
                                ...
                                <s:iterator value="pageResult.items" status="st">
                                    <tr>
                                        ...
                                        <td>
                                            <s:property value="checkFrequencyNumber"/>
                                        </td>

                                        <td><s:property value="checkFrequencyName"/></td>

                                        <td class="hidden-480">
                                            <s:property value="exemptFrequency==true?'是':'否'"/></td>

                                        <td><s:property value="minCheckInterval"/></td>
                                        <td>
                                            <s:date name="apparatusStartDate" format="yyyy-MM-dd"/>
                                        </td>
                                        <td>
                                            <s:date name="aovStartDate" format="yyyy-MM-dd"/>
                                        </td>
                                        ...
                                        <td style="width: 70px">
                                            <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                ...
                                                <button class="btn btn-xs btn-info">
                                                    <a href="${basePath}/paramsetting/checkrepairsetting/check_fren_editUI.action?checkFrequency.id=<s:property value='id'/>">
                                                        <i class="icon-edit bigger-120"></i>
                                                    </a>
                                                </button>

                                                <button class="btn btn-xs btn-danger">
                                                    <a href="${basePath}/paramsetting/checkrepairsetting/check_fren_delete.action?checkFrequency.id=<s:property value='id'/>">
                    ...
                    <form id="form_pageNavigator"
                          action="${basePath}/paramsetting/checkrepairsetting/check_fren_listUI.action">
