...
%>
<!DOCTYPE html>
<html lang="en">    <!--paramsetting.modifyreasonsetting.forever2move.action;   ForeverMoveReason  ---->
<head>
    ...
    <script type="text/javascript">
        ...
        function doDeleteAll(){
            var formDeviceTypes = document.getElementById("from-input_code_by_manu");
            formDeviceTypes.action = "${basePath}/paramsetting/modifyreasonsetting/input_code_by_manu_deleteSelected.action";
...
<div class="main-container" id="main-container">
    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
                        ...
                        <div class="panel-collapse collapse in" id="collapseOne">
                            <div class="panel-body">
                                ...
                                <form class="form-vertical"  id="from-search" role="form" method="post" enctype="multipart/form-data"
                                      action="${basePath}/paramsetting/modifyreasonsetting/input_code_by_manu_listUI.action?pageNo=1">

                                    <div class="form-group">  <!--  表格的一行-->
                                        <label > 编号:</label>
                                        <s:textfield name="manuInputCodeReason.manuInputCodeReasonNumber" id="manuInputCodeReasonNumber"/>
                                        &nbsp &nbsp &nbsp &nbsp
                                        <label > 手动输入条形码原因:</label>
                                        <s:textfield name="manuInputCodeReason.manuInputCodeReasonName" cssClass="s_text" id="manuInputCodeReasonName"/>
                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            ...
            <div class="well">
                <h5 class="green smaller lighter">手动输入条形码原因
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    ...
                    <a href="${basePath}/paramsetting/modifyreasonsetting/input_code_by_manu_addUI.action">
                ...
                <form id="from-input_code_by_manu"  method="post">
                ...
                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                    ...
                    <s:iterator value="pageResult.items" status="st">
                        <tr>
                            ...
                            <td>
                                <s:property value="manuInputCodeReasonNumber"/>
                            </td>

                            <td><s:property value="manuInputCodeReasonName"/></td>
                            ...
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                    ...
                                    <button class="btn btn-xs btn-info">
                                        <a href="${basePath}/paramsetting/modifyreasonsetting/input_code_by_manu_editUI.action?manuInputCodeReason.id=<s:property value='id'/>">
                                            <i class="icon-edit bigger-120"></i>
                                        </a>
                                    </button>

                                    <button class="btn btn-xs btn-danger">
                                        <a href="${basePath}/paramsetting/modifyreasonsetting/input_code_by_manu_delete.action?manuInputCodeReason.id=<s:property value='id'/>">
                ...
                <form id="form_pageNavigator" action="${basePath}/paramsetting/modifyreasonsetting/input_code_by_manu_listUI.action">
