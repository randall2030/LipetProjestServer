                        ...
                        <div class="panel-collapse collapse in" id="collapseOne">
                            <div class="panel-body">
                                ...
                                <form class="form-vertical" id="from-export" role="form" method="post"
                                      action="${basePath}/report/check_history_exportCheckInfo.action">
                                    ...
                                    <div class="checkbox">
                                        <div class="col-md-3 col-md-offset-9">
                                            ...
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="siezMM" type="checkbox"
                                                           checked="checked" class="ace"/>
                                            ...
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="diffToCheck" type="checkbox"
                                                           checked="checked" class="ace"/>
                                            ...
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="leakThreshold"
                                                           type="checkbox" checked="checked" class="ace"/>
                                                    <span class="lbl">泄漏阈值</span>
                                                </label>
                                            </div>
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="startTime" type="checkbox"
                                                           checked="checked" class="ace"/>
                                            ...
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="checkPerson"
                                                           type="checkbox" checked="checked" class="ace"/>
                                            ...
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="checkEquipment"
                                                           type="checkbox" checked="checked" class="ace"/>
                                            ...
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="backgroundPPMNumber"
                                                           type="checkbox" checked="checked" class="ace"/>
                                            ...
                                            <div>
                                                <label>
                                                    <input name="exportItem" value="PPMNumber" type="checkbox"
                                                           checked="checked" class="ace"/>
