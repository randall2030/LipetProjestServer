    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/modelinfosetting/caculate_type_edit.action">
                        <div class="form-group center">
                            <label  > 计算类别编号 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="caculateType.caculateTypeNumber"/>
                        </div>
                        <div class="form-group center">
                            <label  > 计算类别名称 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="caculateType.caculateTypeName"/>
                        </div>
                        ...
                        <s:hidden name="caculateType.id"/>
                        <s:hidden name="caculateType.createPerson"/>
                        <s:hidden name="caculateType.createTime"/>
                    </form>
