    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                            ...
                            <div class="panel-collapse collapse in" id="collapseOne">
                                <div class="panel-body">
                                    ...
                                    <form class="form-vertical" id="from-query" role="form" method="post"
                                          action="${basePath}/view/check_info_listUI.action?pageNo=1">
                                        ...
                                        <div class="form-group align-right">
                                            ...
                                            <label>净PPM值：</label>
                                            <input type="text" name="clearPPMNumberStart" size="15px">-
                                            <input type="text" name="clearPPMNumberEnd" size="15px">
                ...
                <div class="well">
                    <h5 class="blue smaller lighter">检测信息
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            ...
                            <s:iterator value="pageResult.items" status="st">
                                ...
                                <td>
                                    <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                        <a href="${basePath}/view/check_info_editUI.action?moduleCheck.id=<s:property value='checkId'/>&editPageNo=<s:property value='pageResult.pageNo'/>">
                                            <i class="icon-edit bigger-120"></i>
                                        </a>
                                        <a href="${basePath}/view/check_info_delete.action?moduleCheck.id=<s:property value='checkId'/>">
                                ...
                                <td class="hidden-480"><s:property value="labelNumber"/></td>

                                <td><s:property value="extendNumber + 1"/></td>
                                ...
                                <td class="hidden-480">
                                    <s:property value="nextCheckTime"/>
                                </td>
                    ...
                    <form id="form_pageNavigator" action="${basePath}/view/check_info_listUI.action">
                        ...
                        <s:hidden name="clearPPMNumberStart"/>
                        <s:hidden name="clearPPMNumberEnd"/>
