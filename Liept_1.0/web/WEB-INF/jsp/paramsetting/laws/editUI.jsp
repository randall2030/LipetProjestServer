        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    ...
                    <form role="form" class="center" action="${basePath}/paramsetting/laws_edit.action" id="law">
                        <div class="form-group">&nbsp; &nbsp; &nbsp; &nbsp;
                            <label> 法规代码 </label>
                            <s:textfield name="law.lawCode"/>
                        </div>

                        <div class="form-group">&nbsp; &nbsp; &nbsp; &nbsp;
                            <label>法规描述 </label>
                            <s:textarea name="law.lawDesc"/>
                        </div>
                        <div class="form-group">&nbsp;&nbsp;&nbsp;&nbsp;
                            <label style="margin-left: 23px;">备注 </label>&nbsp;&nbsp; &nbsp;
                            <s:textarea name="law.lawRemark"/>
                        </div>

                        <div class="form-group">&nbsp; &nbsp; &nbsp; &nbsp;
                            <label>当前法规 </label>
                            <s:radio list="#{'true':'是','false':'否'}" name="law.currentLaw" />
                        </div>
