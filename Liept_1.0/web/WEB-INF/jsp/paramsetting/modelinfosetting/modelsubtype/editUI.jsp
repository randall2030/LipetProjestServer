    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/modelinfosetting/model_sub_type_edit.action">
                        <div class="form-group center">
                            <label  > 组件子类型编号 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="modelSubType.modelSubTypeNumber"/>
                        </div>
                        <div class="form-group center">
                            <label  > 组件子类型名称 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="modelSubType.modeSubTypeName"/>
                        </div>

                        <div class="form-group center">
                            <label  > 组件类型 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="modelSubType.modelType"/>
                        </div>
                        ...
                        <s:hidden name="modelSubType.id"/>
                        <s:hidden name="modelSubType.createPerson"/>
                        <s:hidden name="modelSubType.createTime"/>
                    </form>
