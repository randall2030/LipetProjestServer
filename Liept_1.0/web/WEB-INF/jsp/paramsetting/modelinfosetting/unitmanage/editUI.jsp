    ...
    <div class="main-container-inner">             <!-- 还是最外层-->
        ...
        <div class="main-content">             <!-- 右边内容界面-->
            ...
            <div class="page-content">     <!-- 右边内容界面的导航栏下的内容主界面-->
                ...
                <div class="well">
                    <form  role="form" action="${basePath}/paramsetting/modelinfosetting/unit_manage_edit.action">
                        <div class="form-group center">
                            <label  > 单位编号 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="unit.unitNumber"/>
                        </div>
                        <div class="form-group center">
                            <label  > 单位名称 </label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:textfield name="unit.unitName"/>
                        </div>
                        ...
                        <s:hidden name="unit.createPerson"/>
                        <s:hidden name="unit.createTime"/>
                    </form>
